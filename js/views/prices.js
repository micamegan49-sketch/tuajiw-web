  ...
  const RAISE = {
    tiers: [
      ...
      { k: 'high', label: 'พรีเมียม', sub: 'ร.ร.เอกชนชั้นนำ / สองภาษา',            once: 150000, m: [15000, 18000, 35000, 50000, 60000, 70000, 60000] },
      {
        ...
        breakdown: [
          [{ l: 'นม/อาหาร', w: 25 }, { l: 'พี่เลี้ยง/เนอสเซอรี่', w: 30 }, { l: 'แพมเพิส', w: 12 }, { l: 'สุขภาพ/วัคซีน (รพ.เอกชน)', w: 13 }, { l: 'เสื้อผ้า/ของใช้', w: 10 }, { l: 'เบ็ดเตล็ด', w: 10 }],
          [{ l: 'ค่าเทอมเตรียมอนุบาล (อินเตอร์)', w: 45 }, { l: 'อาหาร', w: 18 }, { l: 'พี่เลี้ยง', w: 15 }, { l: 'เสื้อผ้า/ของใช้', w: 8 }, { l: 'สุขภาพ', w: 7 }, { l: 'เบ็ดเตล็ด', w: 7 }],
          [{ l: 'ค่าเทอมอนุบาล (อินเตอร์)', w: 60 }, { l: 'อาหาร', w: 12 }, { l: 'กิจกรรม/คอร์สเสริม', w: 10 }, { l: 'รถรับส่ง/เดินทาง', w: 6 }, { l: 'ชุด/อุปกรณ์', w: 5 }, { l: 'เบ็ดเตล็ด', w: 7 }],
          [{ l: 'ค่าเทอมประถม (อินเตอร์)', w: 60 }, { l: 'อาหาร', w: 12 }, { l: 'ดนตรี/กีฬา/กิจกรรม', w: 10 }, { l: 'รถรับส่ง/เดินทาง', w: 6 }, { l: 'ชุด/อุปกรณ์', w: 5 }, { l: 'เบ็ดเตล็ด', w: 7 }],
          [{ l: 'ค่าเทอมมัธยมต้น (อินเตอร์)', w: 60 }, { l: 'อาหาร', w: 12 }, { l: 'ติว/กิจกรรม', w: 10 }, { l: 'เดินทาง', w: 6 }, { l: 'อุปกรณ์/ไอที', w: 5 }, { l: 'เบ็ดเตล็ด', w: 7 }],
          [{ l: 'ค่าเทอมมัธยมปลาย (อินเตอร์)', w: 60 }, { l: 'ติว/สอบ IELTS-SAT', w: 11 }, { l: 'อาหาร', w: 11 }, { l: 'เดินทาง', w: 6 }, { l: 'อุปกรณ์/ไอที', w: 5 }, { l: 'เบ็ดเตล็ด', w: 7 }],
          [{ l: 'ค่าเทอม (หลักสูตรอินเตอร์)', w: 45 }, { l: 'ที่พัก/หอ', w: 20 }, { l: 'อาหาร', w: 17 }, { l: 'เดินทาง', w: 7 }, { l: 'หนังสือ/อุปกรณ์', w: 5 }, { l: 'เบ็ดเตล็ด', w: 6 }]
        ]
      }
    ],
    stages: [
    ...
    root.innerHTML = `
      ...
      <div class="card" style="padding:6px 14px">
        ...
        ${rows.map((r, i) => `<div>
          ...
          ${detailBox('ค่าใช้จ่ายพื้นฐานต่อเดือน (โดยประมาณ)', catRows(r.perMonth, (tier.breakdown && tier.breakdown[i]) || RAISE.breakdown[i]))}
        </div>`).join('')}
